		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						<div><strong>商品名称 <a style="color: red">${product.pname }</a> </strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>商品编号：${product.pid }</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.shop_price }元/份</strong> 市场价： <del>￥6.00元/份</del>
						</div>
