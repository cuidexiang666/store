	...
	<head>
		...
		<script type="text/javascript">
			$(function(){
				//alert(11);
				//显示热门商品
				$.post("${pageContext.request.contextPath}/ProductServlet?is_hot=0",{method:"findHotProduct"},function(data){
					//alert(data);
						if(data!=""){
							//有数据
							$(data).each(function(i,m){
								/* alert(m.pimage); */
								var temp = '<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">'+
												'<a href="product_info.htm" >'+ 
													'<img src="${pageContext.request.contextPath}/'+m.pimage+'"'+
													'width="130" height="130" style="display: inline-block;">  ' +
												'</a>'+
												'<p><a href="product_info.html" style="color:#666">'+m.pname+'</a></p>'+
												'<p><font color="#E4393C" style="font-size:16px">&yen;'+m.shop_price+'</font></p>'+ 
											'</div>';
						$("#hotProductor").append(temp); 
							});
						}
				},"json"); 
				
				//显示最新商品
				$.post("${pageContext.request.contextPath}/ProductServlet",{method:"findNewProduct"},function(data){
					//alert(data);
						if(data!=""){
							//有数据
							$(data).each(function(i,m){
	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10" id="hotProductor">
